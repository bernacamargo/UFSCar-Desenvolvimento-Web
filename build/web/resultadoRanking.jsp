  ...
  <body>
    ...
    %>
		...
		<div id="result" class="col-md-12">
			...
			<h1>Resultados</h1>
                        <h3>Gênero: <b><% out.println(genero); %></b> <br> De:&ensp;<b><% out.println(ano_inicio); %></b> até&ensp;<% out.println(ano_fim); %></h3>
			<hr>
                    </div>
						...
						<th>Nome</th>
                                        ...
                                        <% 
                                            for (int i = 0 ; i < res.size() ; i++){
                                                out.println("<tr><td><b>"+ (i+1) +"</b></td>" + res.returnAtor(i) + "</tr>");
                                            }
                                        %>
